...
% set run parameters
runID    = 'meltflush';          % run identifier
restart  =  5;                   % restart from file (0: new run; <1: restart from last; >1: restart from specified frame)
...
n        =  0.66;                % non-Newtonian shear viscosity powerlaw
lambda   =  35;                  % exponential melt weakening factor
...
alpha    =  0.50;                % inner its step size (fraction of stable step) [0,1]
