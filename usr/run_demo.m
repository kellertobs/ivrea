...
Pu       = -1/32;                % ratio of pure-shear stress to buoyancy pressure
Si       =  0;                   % ratio of simple-shear stress to buoyancy pressure
B        =  1/4;                 % ratio of buoyancy pressure to tensile strength
...
T2       =  0.025;               % amplitude of gaussian
...
MAJ0     =  0.11;                % initial major element composition
MAJ1     =  0.05;                % amplitude of random noise   
MAJ2     = -0.15;                % amplitude of gaussian
...
maxit    =  2e3;                 % maximum solver iterations
alpha    =  0.75;                % inner its step size (fraction of stable step) [0,1]
