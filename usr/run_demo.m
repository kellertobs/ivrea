...
Pu       =  -1/L;                % ratio of pure-shear stress to buoyancy pressure
Si       =  0;                   % ratio of simple-shear stress to buoyancy pressure
Ty       =  1/8;                 % ratio of tensile strength to buoyancy pressure 
...
T2       =  0.006;               % amplitude of gaussian (abs)
D        =  0.60*L;              % thermal boundary layer thickness
PeT      =  1.4;                 % thermal Peclet number [u0.h0/kappaT0]
...
MAJ0     =  0.14;                % initial major element composition
...
DIRP     =  5.0;                 % parent isotope decay number (dimensionless half-life)
...
minit    =  4;                   % minimum solver iterations
maxit    =  8;                   % maximum solver iterations
alpha    =  0.25;                % inner its step size (fraction of stable step) [0,1]
beta     =  0.50;                % iterative damping parameter (fraction of previous step) [0,1]
gamma    =  0.75;                % iterative relaxation for rheology updates [0,1]
delta    =  5e-2;                % numerical compressibility for P-diagonal stabilisation
